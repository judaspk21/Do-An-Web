				...
				<div class="row">
					<div class="container">
						<div class=" col-md-6 col-lg-12" style="box-shadow: 0 5px 10px rgba(0, 0, 0, 0.20)">
							<form:form action="/category/insert" method="post"
								modelAttribute="category">
								<div class="form-group">
									<label class="col-sm-4 control-label"></label>
									<div class="col-sm-9">
										<form:input class="form-control" type="text" disabled="true" 
								...
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
										<button type="submit" value="gửi" class="btn btn-success">Thêm</button>
									</div>
								</div>
							</form:form>
						</div>
